import{r as n,j as r}from"./three-DV31HySq.js";import{r as i,an as c,u as l,a as d,ar as p,d as e}from"./index-BarUt2o_.js";import"./react-vendor-faCf7XlP.js";import"./blockchain-C0nfa7Sw.js";import"./physics-audio-Bm3pLP40.js";const b=e.div`
  position: fixed;
  top: 0;
  left: 0;
  right: 0;
...
`;function k(){const o=d("Bonus","Claim your casino bonuses and rewards! Get free spins, deposit bonuses, and special promotions"),a=i(),{mobile:s}=c(),{currentColorScheme:t}=l();return n.useEffect(()=>{s||a("/")},[s]),r.jsxs(r.Fragment,{children:[o,r.jsxs(b,{$colorScheme:t,children:[r.jsxs(f,{$colorScheme:t,children:[r.jsx(u,{$colorScheme:t,children:"🎁 Bonus"}),r.jsx(m,{$colorScheme:t,onClick:()=>a(-1),"aria-label":"Close",children:"✕ Close"})]}),r.jsx(g,{children:r.jsx(p,{})})]})]})}export{k as default};
