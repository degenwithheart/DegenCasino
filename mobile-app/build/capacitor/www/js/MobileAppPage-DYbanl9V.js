import{r as y,j as o}from"./three-DV31HySq.js";import{u as w,au as k,av as j,bg as p,bh as c,d as t,be as n,as as m,ax as v,ay as F,az as C,a1 as z,aw as D,aA as A,m as g}from"./index-BarUt2o_.js";import"./react-vendor-faCf7XlP.js";import"./blockchain-C0nfa7Sw.js";import"./physics-audio-Bm3pLP40.js";const P=g`
  0%, 100% {
...
`,K=t.div`
  ...
  &::before {
    ...
    ${n`animation: ${T} 3s ease-in-out infinite;`}
  }
...
`,L=t.h1`
  ...
  &::after {
    ...
    right: -20px;
    font-size: 2rem;
    ${n`animation: ${Y} 2s ease-in-out infinite;`}
  }
`,B=t.p`
  font-size: 1.25rem;
  margin-bottom: 2rem;
...
`,S=t(m.a)`
  ...
  ${e=>e.$variant==="primary"?n`
    ...
    ${n`animation: ${P} 3s ease-in-out infinite;`}
