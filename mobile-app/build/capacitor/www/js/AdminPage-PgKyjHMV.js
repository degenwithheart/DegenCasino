import{r as m,j as i}from"./three-DV31HySq.js";import{j as Y,an as W,u as K,P as b,aB as J,d as a,m as w}from"./index-BarUt2o_.js";import"./react-vendor-faCf7XlP.js";import"./blockchain-C0nfa7Sw.js";import"./physics-audio-Bm3pLP40.js";const I=w`
...
`,s+=`📅 ${new Date(e.timestamp).toLocaleString()}`,s},L=e=>{if(!e)return"No data received";const t=e.overallStatus||"unknown";let s=`${t==="healthy"?"🟢":t==="degraded"?"🟡":"🔴"} RPC HEALTH STATUS: ${t.toUpperCase()}
`;return s+=`═══════════════════════════════════════
...
`,s+=`📅 ${new Date(e.timestamp).toLocaleString()}`,s},v=e=>{if(!e)return"No data received";let t=`📊 API USAGE METRICS REPORT (REAL DATA)
`;if(t+=`${"═".repeat(50)}
