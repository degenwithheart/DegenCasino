import{r as i,j as r}from"./three-DV31HySq.js";import{r as n,an as c,u as l,a as d,ao as p,d as e}from"./index-BarUt2o_.js";import"./react-vendor-faCf7XlP.js";import"./blockchain-C0nfa7Sw.js";import"./physics-audio-Bm3pLP40.js";const f=e.div`
  position: fixed;
  top: 0;
  left: 0;
  right: 0;
...
`;function w(){const o=d("Jackpot","Check out massive jackpot prizes! See current jackpot amounts and recent big wins from our casino games"),a=n(),{mobile:s}=c(),{currentColorScheme:t}=l();return i.useEffect(()=>{s||a("/")},[s]),r.jsxs(f,{$colorScheme:t,children:[o,r.jsxs(b,{$colorScheme:t,children:[r.jsx(m,{$colorScheme:t,children:"🎰 Jackpot"}),r.jsx(u,{$colorScheme:t,onClick:()=>a(-1),"aria-label":"Close",children:"✕ Close"})]}),r.jsx(g,{children:r.jsx(p,{})})]})}export{w as default};
