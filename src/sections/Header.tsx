      ...
      <StyledHeader>
        ...
        <RightGroup $isCompact={isCompact}>
          {pool.jackpotBalance > 0 && (
            <JackpotBonus onMouseEnter={pfJackpot} onFocus={pfJackpot} onClick={() => (mobile ? navigate('/jackpot') : setJackpotHelp(true))} aria-label="Jackpot info" $theme={currentTheme}>
              💰
              {!isCompact && 'Jackpot'}
            </JackpotBonus>
          )}

          <Bonus onMouseEnter={pfBonus} onFocus={pfBonus} onClick={() => (mobile ? navigate('/bonus') : setBonusHelp(true))} aria-label="Bonus info" $theme={currentTheme}>
            ✨
            {!isCompact && 'Bonus'}
          </Bonus>
          ...
          <ThemeButton onClick={() => setShowSettings(true)} aria-label="Open Settings" $theme={currentTheme}>
            ⚙️
            {!isCompact && ' Settings'}
          </ThemeButton>
