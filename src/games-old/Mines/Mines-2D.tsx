...
export default function MinesV2() {
  ...
  const config = BET_ARRAYS_V3['mines']
    // Calculate max possible multiplier with adjusted RTP
    const totalSafeCells = MINES_GRID_SIZE - mineCount
    return config.calculateBetArray(mineCount, 0)[1] // Get initial multiplier
  }, [mineCount])
