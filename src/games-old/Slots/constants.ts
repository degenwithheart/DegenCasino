...
import { BET_ARRAYS, SLOTS_CONFIG } from '../rtpConfig-v3'
...
export const SLOT_ITEMS: SlotItem[] = BET_ARRAYS_V3.slots.symbols.map((symbol: { name: string, multiplier: number }) => ({
...
//
export const LEGENDARY_THRESHOLD = BET_ARRAYS_V3.slots.LEGENDARY_THRESHOLD
