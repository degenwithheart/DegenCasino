// Holy Grail Game.tsx - Complete Game component modified for holy-grail layout
// This removes the stats portal target to prevent conflicts with the right sidebar
...
// Error Screen Component (copied from main Game.tsx)
const ErrorScreen = ({
  type,
  message,
  details,
...
// Custom Renderer for Holy Grail theme (REMOVES STATS PORTAL TARGET)
function HolyGrailCustomRenderer() {
  ...
  console.log('HolyGrailCustomRenderer render:', { showSplash, ready, gameName: game.meta.name })
    ...
    <>
      ...
      {fullscreen && (
        ...
        <Container key={`game-container-${renderKey}`}>
          {/* REMOVED: Stats header portal target - this prevents conflicts with holy-grail right sidebar */}
...
// Main Game Component for Holy Grail Theme
export default function HolyGrailGame() {
