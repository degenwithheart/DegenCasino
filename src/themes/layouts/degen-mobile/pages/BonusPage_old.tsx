...
// Modal container with modern styling - bonus themed
const ModalContainer = styled.div`
  ...
  box-shadow: 
    0 20px 60px rgba(162, 89, 255, 0.3),
...
export default function BonusPage() {
  const seoHelmet = usePageSEO(
    "Bonus", 
    "Claim your bonus rewards and check your bonus balance. Get free tokens to play games!"
  )
