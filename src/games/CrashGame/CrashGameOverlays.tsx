...
interface CrashGameOverlaysProps {
  gamePhase: GamePhase;
...
export const CrashGameOverlays: React.FC<CrashGameOverlaysProps> = ({
  gamePhase,
  thinkingPhase,
  dramaticPause,
  ...
  wager
    ...
    // Custom win levels for CrashGame
  const crashgameWinLevels = [
    {
        "minMultiplier": 1,
        "maxMultiplier": 2,
        "intensity": 1,
      ...
      {gamePhase === 'thinking' && thinkingPhase && (
        <div className="thinking-overlay">
          <div className="thinking-content">
            ...
            <div className="thinking-text">Predicting the crash point...</div>
            <div className="thinking-subtext">🚀 Calculating rocket trajectory... 🚀</div>
          </div>
        </div>
      )}
      ...
      {gamePhase === 'mourning' && (
        <div className="mourning-overlay">
          <div className="mourning-content">
            ...
            <div className="mourning-text">Rocket crashed too early!</div>
            <div className="mourning-subtext">🚀 Should've cashed out sooner... 🚀</div>
          </div>
        </div>
      )}
...
export default CrashGameOverlays;
