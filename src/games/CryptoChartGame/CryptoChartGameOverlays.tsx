...
interface CryptoChartGameOverlaysProps {
  gamePhase: GamePhase;
...
export const CryptoChartGameOverlays: React.FC<CryptoChartGameOverlaysProps> = ({
  gamePhase,
  thinkingPhase,
  dramaticPause,
  ...
  wager
    ...
    // Custom win levels for CryptoChartGame
  const cryptochartgameWinLevels = [
    {
        "minMultiplier": 1,
        "maxMultiplier": 3,
        "intensity": 1,
  ...
  return (
    <>
      ...
      <SyncedWinLossOverlay
        ...
        wager={wager}
        winLevels={cryptochartgameWinLevels}
      />
      ...
      {gamePhase === 'thinking' && thinkingPhase && (
        <div className="thinking-overlay">
          <div className="thinking-content">
            ...
            <div className="thinking-text">Analyzing market trends...</div>
            <div className="thinking-subtext">📈 Reading crypto signals... 📈</div>
          </div>
        </div>
      )}
      ...
      {gamePhase === 'mourning' && (
        <div className="mourning-overlay">
          <div className="mourning-content">
            ...
            <div className="mourning-text">Market went against you!</div>
            <div className="mourning-subtext">📈 The charts were unpredictable... 📈</div>
          </div>
        </div>
      )}
...
export default CryptoChartGameOverlays;
