...
export const DiceRollOverlays: React.FC<DiceRollOverlaysProps> = ({
  gamePhase,
  thinkingPhase,
  dramaticPause,
  ...
  wager
    ...
    // Custom win levels for DiceRoll
  const dicerollWinLevels = [
    {
        "minMultiplier": 1,
        "maxMultiplier": 3,
        "intensity": 1,
      ...
      {gamePhase === 'thinking' && thinkingPhase && (
        <div className="thinking-overlay">
          <div className="thinking-content">
            ...
            <div className="thinking-text">Rolling the perfect dice...</div>
            <div className="thinking-subtext">🎲 Shaking the dice gods... 🎲</div>
          </div>
        </div>
      )}
      ...
      {gamePhase === 'mourning' && (
        <div className="mourning-overlay">
          <div className="mourning-content">
            ...
            <div className="mourning-text">Snake eyes!</div>
            <div className="mourning-subtext">🎲 The dice rolled against you... 🎲</div>
          </div>
        </div>
      )}
...
export default DiceRollOverlays;
