      ...
      {gamePhase === 'thinking' && thinkingPhase && (
        <div className="thinking-overlay">
          <div className="thinking-content">
            ...
            <div className="thinking-text">Calculating the perfect flip...</div>
            <div className="thinking-subtext">🪙 Calling heads or tails... 🪙</div>
          </div>
        </div>
      )}
      ...
      {gamePhase === 'mourning' && (
        <div className="mourning-overlay">
          <div className="mourning-content">
            ...
            <div className="mourning-text">Better luck next flip!</div>
            <div className="mourning-subtext">🪙 The coin has spoken... 🪙</div>
          </div>
        </div>
      )}
