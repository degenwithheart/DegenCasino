      ...
      {gamePhase === 'thinking' && thinkingPhase && (
        <div className="thinking-overlay">
          <div className="thinking-content">
            ...
            <div className="thinking-text">Calculating ball physics...</div>
            <div className="thinking-subtext">🎡 Spinning the wheel of fortune... 🎡</div>
          </div>
        </div>
      )}
      ...
      {gamePhase === 'mourning' && (
        <div className="mourning-overlay">
          <div className="mourning-content">
            ...
            <div className="mourning-text">Ball missed your bet!</div>
            <div className="mourning-subtext">🎡 The wheel spun away from you... 🎡</div>
          </div>
        </div>
      )}
...
export default RouletteOverlays;
