...
interface WheelSpinOverlaysProps {
  gamePhase: GamePhase;
...
export const WheelSpinOverlays: React.FC<WheelSpinOverlaysProps> = ({
  gamePhase,
  thinkingPhase,
  dramaticPause,
  ...
  wager
    ...
    // Custom win levels for WheelSpin
  const wheelspinWinLevels = [
    {
        "minMultiplier": 1,
        "maxMultiplier": 3,
        "intensity": 1,
      ...
      {gamePhase === 'thinking' && thinkingPhase && (
        <div className="thinking-overlay">
          <div className="thinking-content">
            ...
            <div className="thinking-text">Spinning the fortune wheel...</div>
            <div className="thinking-subtext">🎰 Aligning cosmic forces... 🎰</div>
          </div>
        </div>
      )}
      ...
      {gamePhase === 'mourning' && (
        <div className="mourning-overlay">
          <div className="mourning-content">
            ...
            <div className="mourning-text">Wheel stopped on empty!</div>
            <div className="mourning-subtext">🎰 Fortune wheel wasn't spinning for you... 🎰</div>
          </div>
        </div>
      )}
...
export default WheelSpinOverlays;
