...
interface ScissorsOverlaysProps {
  gamePhase: GamePhase;
...
export const ScissorsOverlays: React.FC<ScissorsOverlaysProps> = ({
  gamePhase,
  thinkingPhase,
  dramaticPause,
  ...
  wager
    ...
    // Custom win levels for Scissors
  const scissorsWinLevels = [
    {
        "minMultiplier": 1,
        "maxMultiplier": 3,
        "intensity": 1,
      ...
      {gamePhase === 'thinking' && thinkingPhase && (
        <div className="thinking-overlay">
          <div className="thinking-content">
            ...
            <div className="thinking-text">Strategizing rock paper scissors...</div>
            <div className="thinking-subtext">✂️ Reading opponent's mind... ✂️</div>
          </div>
        </div>
      )}
      ...
      {gamePhase === 'mourning' && (
        <div className="mourning-overlay">
          <div className="mourning-content">
            ...
            <div className="mourning-text">Wrong choice!</div>
            <div className="mourning-subtext">✂️ Your strategy was countered... ✂️</div>
          </div>
        </div>
      )}
...
export default ScissorsOverlays;
