...
interface LuckyNumberOverlaysProps {
  gamePhase: GamePhase;
...
export const LuckyNumberOverlays: React.FC<LuckyNumberOverlaysProps> = ({
  gamePhase,
  thinkingPhase,
  dramaticPause,
  ...
  wager
    ...
    // Custom win levels for LuckyNumber
  const luckynumberWinLevels = [
    {
        "minMultiplier": 1,
        "maxMultiplier": 3,
        "intensity": 1,
  ...
  return (
    <>
      ...
      <SyncedWinLossOverlay
        ...
        wager={wager}
        winLevels={luckynumberWinLevels}
      />
      ...
      {gamePhase === 'thinking' && thinkingPhase && (
        <div className="thinking-overlay">
          <div className="thinking-content">
            ...
            <div className="thinking-text">Searching for your lucky number...</div>
            <div className="thinking-subtext">🍀 Channeling fortune... 🍀</div>
          </div>
        </div>
      )}
      ...
      {gamePhase === 'mourning' && (
        <div className="mourning-overlay">
          <div className="mourning-content">
            ...
            <div className="mourning-text">Luck wasn't on your side!</div>
            <div className="mourning-subtext">🍀 Your lucky number is hiding... 🍀</div>
          </div>
        </div>
      )}
...
export default LuckyNumberOverlays;
