...
interface ProgressivePokerOverlaysProps {
...
export const ProgressivePokerOverlays: React.FC<ProgressivePokerOverlaysProps> = ({
  gamePhase,
  thinkingPhase,
  dramaticPause,
  ...
  wager
    ...
    // Custom win levels for ProgressivePoker
  const progressivepokerWinLevels = [
    {
        "minMultiplier": 1,
        "maxMultiplier": 3,
        "intensity": 1,
  ...
  return (
    <>
      ...
      <SyncedWinLossOverlay
        ...
        wager={wager}
        winLevels={progressivepokerWinLevels}
      />
      ...
      {gamePhase === 'thinking' && thinkingPhase && (
        <div className="thinking-overlay">
          <div className="thinking-content">
            ...
            <div className="thinking-text">Analyzing poker hands...</div>
            <div className="thinking-subtext">🃑 Reading the table... 🃑</div>
          </div>
        </div>
      )}
      ...
      {gamePhase === 'mourning' && (
        <div className="mourning-overlay">
          <div className="mourning-content">
            ...
            <div className="mourning-text">No winning hand!</div>
            <div className="mourning-subtext">🃑 The poker gods weren't smiling... 🃑</div>
          </div>
        </div>
      )}
...
export default ProgressivePokerOverlays;
