...
export const FancyVirtualHorseRacingOverlays: React.FC<FancyVirtualHorseRacingOverlaysProps> = ({
  ...
  wager
    ...
    // Custom win levels for FancyVirtualHorseRacing
  const fancyvirtualhorseracingWinLevels = [
    {
        "minMultiplier": 1,
        "maxMultiplier": 3,
        "intensity": 1,
      ...
      {gamePhase === 'thinking' && thinkingPhase && (
        <div className="thinking-overlay">
          <div className="thinking-content">
            ...
            <div className="thinking-text">Analyzing horse stats...</div>
            <div className="thinking-subtext">🐎 Checking track conditions... 🐎</div>
          </div>
        </div>
      )}
      ...
      {gamePhase === 'mourning' && (
        <div className="mourning-overlay">
          <div className="mourning-content">
            ...
            <div className="mourning-text">Your horse came last!</div>
            <div className="mourning-subtext">🐎 Better luck at the next race... 🐎</div>
          </div>
        </div>
      )}
...
export default FancyVirtualHorseRacingOverlays;
