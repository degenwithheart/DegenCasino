      ...
      {gamePhase === 'thinking' && thinkingPhase && (
        <div className="thinking-overlay">
          <div className="thinking-content">
            ...
            <div className="thinking-text">Calculating ball trajectory...</div>
            <div className="thinking-subtext">🎯 Analyzing peg bounces... 🎯</div>
          </div>
        </div>
      )}
      ...
      {gamePhase === 'mourning' && (
        <div className="mourning-overlay">
          <div className="mourning-content">
            ...
            <div className="mourning-text">Ball missed the big slots!</div>
            <div className="mourning-subtext">🔮 The pegs weren't on your side... 🔮</div>
          </div>
        </div>
      )}
