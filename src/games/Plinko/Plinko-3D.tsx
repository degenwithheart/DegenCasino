              ...
              <GambaUi.Canvas
                ...
                bodies.forEach((body, i) => {
                  ...
                  if (label === 'Peg') {
                    ...
                    ctx.beginPath()
                    ctx.arc(depthOffset + 2, depthOffset + 2, dynamicPegRadius, 0, Math.PI * 2)
                    ctx.fill()

                    ctx.fillStyle = 'rgba(8, 8, 20, 0.7)'
                    ctx.beginPath()
                    ctx.arc(depthOffset, depthOffset, dynamicPegRadius, 0, Math.PI * 2)
                    ctx.fill()

                    ctx.fillStyle = 'rgba(15, 15, 30, 0.5)'
                    ctx.beginPath()
                    ctx.arc(depthOffset - 1, depthOffset - 1, dynamicPegRadius, 0, Math.PI * 2)
                    ctx.fill()

                    // Create enhanced 3D gradient for peg
                    const pegGradient = ctx.createRadialGradient(0, 0, 0, 0, 0, dynamicPegRadius)
                    pegGradient.addColorStop(0, 'hsla(' + pegHue + ', 85%, 75%, ' + (1 + animationEffect * 2) * 0.9 + ')')    // Bright center
                    pegGradient.addColorStop(0.3, 'hsla(' + pegHue + ', 80%, 65%, ' + (1 + animationEffect * 2) * 0.8 + ')')  // Mid tone
                    pegGradient.addColorStop(0.6, 'hsla(' + pegHue + ', 75%, 55%, ' + (1 + animationEffect * 2) * 0.7 + ')')  // Base color
                    pegGradient.addColorStop(0.8, 'hsla(' + pegHue + ', 70%, 45%, ' + (1 + animationEffect * 2) * 0.6 + ')')  // Shadow area
                    pegGradient.addColorStop(1, 'hsla(' + pegHue + ', 65%, 35%, ' + (1 + animationEffect * 2) * 0.5 + ')')    // Deep shadow

                    // Outer glow effect
                    ctx.shadowColor = 'hsla(' + pegHue + ', 75%, 60%, 0.4)'
                    ctx.shadowBlur = 15
                    ctx.shadowOffsetX = 0
                    ctx.shadowOffsetY = 0
                    ...
                    ctx.strokeStyle = 'hsla(' + pegHue + ', 90%, 80%, 0.8)'
                    ctx.lineWidth = 2
                    ctx.beginPath()
                    ctx.arc(0, 0, dynamicPegRadius, 0, Math.PI * 2)
                    ctx.stroke()
                    ...
                    ctx.lineWidth = 1
                    ctx.beginPath()
                    ctx.arc(0, -dynamicPegRadius * 0.3, dynamicPegRadius * 0.4, 0, Math.PI * 2)
                    ctx.stroke()

                    // Secondary highlight
                    ctx.strokeStyle = 'hsla(' + pegHue + ', 95%, 90%, 0.4)'
                    ctx.lineWidth = 1
                    ctx.beginPath()
                    ctx.arc(0, -dynamicPegRadius * 0.1, dynamicPegRadius * 0.6, 0, Math.PI * 2)
                    ctx.stroke()
                  ...
                  if (label === 'Plinko') {
                    ...
                    if (active) {
                      ...
                      ctx.fillStyle = 'rgba(5, 5, 15, 0.8)'
                      ctx.beginPath()
                      ctx.arc(depthOffset + 2, depthOffset + 2, dynamicBallRadius, 0, Math.PI * 2)
                      ctx.fill()

                      ctx.fillStyle = 'rgba(8, 8, 20, 0.6)'
                      ctx.beginPath()
                      ctx.arc(depthOffset, depthOffset, dynamicBallRadius, 0, Math.PI * 2)
                      ctx.fill()

                      ctx.fillStyle = 'rgba(15, 15, 30, 0.4)'
                      ctx.beginPath()
                      ctx.arc(depthOffset - 1, depthOffset - 1, dynamicBallRadius, 0, Math.PI * 2)
                      ctx.fill()

                      // Create enhanced 3D gradient for ball
                      const ballGradient = ctx.createRadialGradient(
                        -dynamicBallRadius * 0.3, -dynamicBallRadius * 0.3, 0,
                        0, 0, dynamicBallRadius
                      )
                      ballGradient.addColorStop(0, 'hsla(' + ballHue + ', 85%, 95%, 1)')      // Bright highlight
                      ballGradient.addColorStop(0.2, 'hsla(' + ballHue + ', 80%, 85%, 0.9)')  // Light area
                      ballGradient.addColorStop(0.5, 'hsla(' + ballHue + ', 75%, 75%, 0.8)')  // Mid highlight
                      ballGradient.addColorStop(0.7, 'hsla(' + ballHue + ', 70%, 65%, 0.7)')  // Base color
                      ballGradient.addColorStop(0.9, 'hsla(' + ballHue + ', 65%, 55%, 0.6)')  // Shadow
                      ballGradient.addColorStop(1, 'hsla(' + ballHue + ', 60%, 45%, 0.5)')    // Deep shadow

                      // Outer glow effect
                      ctx.shadowColor = 'hsla(' + ballHue + ', 75%, 70%, 0.6)'
                      ctx.shadowBlur = 20
                      ctx.shadowOffsetX = 0
                      ctx.shadowOffsetY = 0
                      ...
                      // Enhanced 3D border effects
                      ctx.strokeStyle = 'hsla(' + ballHue + ', 90%, 85%, 0.8)'
                      ctx.lineWidth = 2
                      ctx.beginPath()
                      ctx.arc(0, 0, dynamicBallRadius, 0, Math.PI * 2)
                      ctx.stroke()
                      ...
                      ctx.lineWidth = 1
                      ctx.beginPath()
                      ctx.arc(-dynamicBallRadius * 0.3, -dynamicBallRadius * 0.3, dynamicBallRadius * 0.4, 0, Math.PI * 2)
                      ctx.stroke()

                      // Secondary highlight
                      ctx.strokeStyle = 'hsla(' + ballHue + ', 95%, 95%, 0.5)'
                      ctx.lineWidth = 1
                      ctx.beginPath()
                      ctx.arc(-dynamicBallRadius * 0.1, -dynamicBallRadius * 0.1, dynamicBallRadius * 0.6, 0, Math.PI * 2)
                      ctx.stroke()
                  ...
                  if (label === 'Bucket') {
                    ...
                    ctx.fillRect(-22 + depthOffset, 1 + depthOffset, 44, bucketHeight + 2)
                    ...
                    bucketGradient.addColorStop(0.5, colors.tertiary.replace('0.9)', `${bucketAlpha * 0.9})`))    // Mid tone
                    bucketGradient.addColorStop(0.7, colors.primary.replace('0.9)', `${bucketAlpha * 0.8})`))     // Base color
                    bucketGradient.addColorStop(0.9, colors.secondary.replace('0.85)', `${bucketAlpha * 0.7})`))  // Shadow area
                    bucketGradient.addColorStop(1, colors.tertiary.replace('0.9)', `${bucketAlpha * 0.6})`))      // Deep shadow

                    // Outer glow effect for buckets
                    ctx.shadowColor = colors.primary.replace('0.9)', '0.4)')
                    ctx.shadowBlur = 15
                    ctx.shadowOffsetX = 0
                    ctx.shadowOffsetY = 0
                    ...
                    // Bright top highlight (raised effect)
                    ctx.strokeStyle = 'rgba(255, 255, 255, 0.6)'
                    ctx.lineWidth = 2
                    ctx.strokeRect(-23, -bucketHeight + 2, 46, bucketHeight - 4)

                    // Secondary highlight
                    ctx.strokeStyle = colors.secondary.replace('0.85)', '0.4)')
                    ctx.lineWidth = 1
                    ctx.strokeRect(-21, -bucketHeight + 4, 42, bucketHeight - 8)

                    // Bottom-right deep shadow
                    ctx.strokeStyle = 'rgba(10, 10, 25, 0.8)'
                    ctx.lineWidth = 2
                    ctx.strokeRect(-21, -4, 42, 2)

                    ctx.restore()

                    // Enhanced text styling with 3D effects
                    ...
                    ctx.shadowColor = colors.primary.replace('0.9)', '0.5)')
                    ctx.shadowBlur = 8
                    ctx.shadowOffsetX = 0
                    ctx.shadowOffsetY = 0
                    ctx.strokeText('x' + bucketMultiplier, 0, 0)

                    // Main text with bright highlight
                    ctx.shadowBlur = 0
                    ctx.fillStyle = `rgba(255, 255, 255, ${0.95 + animation * 0.05})`
                    ctx.fillText('x' + bucketMultiplier, -1, -1)
                  ...
                  if (label === 'Barrier') {
                    ...
                    // Enhanced 3D barrier styling
                    const depthOffset = 4 // Smaller depth offset for barriers

                    // Multiple shadow layers for depth
                    ctx.fillStyle = 'rgba(5, 5, 15, 0.4)'
                    ctx.fillRect(-barrierWidth / 2 + depthOffset + 2, -barrierHeight / 2 + depthOffset + 2, barrierWidth, barrierHeight)

                    ctx.fillStyle = 'rgba(8, 8, 20, 0.3)'
                    ctx.fillRect(-barrierWidth / 2 + depthOffset, -barrierHeight / 2 + depthOffset, barrierWidth, barrierHeight)

                    // Create subtle gradient for barrier
                    const barrierGradient = ctx.createLinearGradient(
                      -barrierWidth / 2, -barrierHeight / 2,
                      barrierWidth / 2, barrierHeight / 2
                    )
                    barrierGradient.addColorStop(0, 'rgba(200, 200, 200, 0.3)')    // Light top-left
                    barrierGradient.addColorStop(0.5, 'rgba(150, 150, 150, 0.25)') // Mid tone
                    barrierGradient.addColorStop(1, 'rgba(100, 100, 100, 0.2)')    // Dark bottom-right

                    // Subtle glow
                    ctx.shadowColor = 'rgba(150, 150, 150, 0.2)'
                    ctx.shadowBlur = 5
                    ctx.shadowOffsetX = 0
                    ctx.shadowOffsetY = 0
