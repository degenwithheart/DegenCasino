...
export const MinesOverlays: React.FC<MinesOverlaysProps> = ({
  gamePhase,
  thinkingPhase,
  dramaticPause,
  ...
  // Custom win levels for Mines
  const minesWinLevels = [
    { 
      minMultiplier: 1, 
      maxMultiplier: 3, 
      intensity: 1,
      ...
      {gamePhase === 'thinking' && thinkingPhase && (
        <div className="thinking-overlay">
          <div className="thinking-content">
            ...
            <div className="thinking-text">Scanning the minefield...</div>
            <div className="thinking-subtext">💣 Detecting safe spots... 💣</div>
          </div>
        </div>
      )}
      ...
      {gamePhase === 'mourning' && (
        <div className="mourning-overlay">
          <div className="mourning-content">
            ...
            <div className="mourning-text">BOOM! Mine exploded!</div>
            <div className="mourning-subtext">💣 Try to avoid the mines next time... 💣</div>
          </div>
        </div>
      )}
