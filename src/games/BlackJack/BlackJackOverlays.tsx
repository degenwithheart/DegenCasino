...
interface BlackJackOverlaysProps {
  gamePhase: GamePhase;
...
export const BlackJackOverlays: React.FC<BlackJackOverlaysProps> = ({
  gamePhase,
  thinkingPhase,
  dramaticPause,
  ...
  // Custom win levels for BlackJack
  const blackjackWinLevels = [
    { 
      minMultiplier: 1, 
      maxMultiplier: 1.5, 
      intensity: 1,
      ...
      {gamePhase === 'thinking' && thinkingPhase && (
        <div className="thinking-overlay">
          <div className="thinking-content">
            ...
            <div className="thinking-text">Calculating card probabilities...</div>
            <div className="thinking-subtext">♠️ Reading the dealer's hand... ♠️</div>
          </div>
        </div>
      )}
      ...
      {gamePhase === 'mourning' && (
        <div className="mourning-overlay">
          <div className="mourning-content">
            ...
            <div className="mourning-text">House wins this round!</div>
            <div className="mourning-subtext">🃏 The cards weren't in your favor... 🃏</div>
          </div>
        </div>
      )}
...
export default BlackJackOverlays;
