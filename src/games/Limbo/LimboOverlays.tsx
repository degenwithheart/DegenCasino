      ...
      {gamePhase === 'thinking' && thinkingPhase && (
        <div className="thinking-overlay">
          <div className="thinking-content">
            ...
            <div className="thinking-text">Finding the limbo sweet spot...</div>
            <div className="thinking-subtext">🎯 Calculating perfect timing... 🎯</div>
          </div>
        </div>
      )}
      ...
      {gamePhase === 'mourning' && (
        <div className="mourning-overlay">
          <div className="mourning-content">
            ...
            <div className="mourning-text">Limbo bar was too low!</div>
            <div className="mourning-subtext">🎯 Couldn't make it under... 🎯</div>
          </div>
        </div>
      )}
