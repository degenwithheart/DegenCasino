      ...
      {gamePhase === 'thinking' && thinkingPhase && (
        <div className="thinking-overlay">
          <div className="thinking-content">
            ...
            <div className="thinking-text">Selecting lucky numbers...</div>
            <div className="thinking-subtext">🔢 Consulting number spirits... 🔢</div>
          </div>
        </div>
      )}
      ...
      {gamePhase === 'mourning' && (
        <div className="mourning-overlay">
          <div className="mourning-content">
            ...
            <div className="mourning-text">Numbers didn't match!</div>
            <div className="mourning-subtext">🔢 The lottery gods weren't listening... 🔢</div>
          </div>
        </div>
      )}
