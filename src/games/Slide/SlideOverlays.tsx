...
export const SlideOverlays: React.FC<SlideOverlaysProps> = ({
  ...
  wager
    ...
    // Custom win levels for Slide
  const slideWinLevels = [
    {
        "minMultiplier": 1,
        "maxMultiplier": 3,
        "intensity": 1,
      ...
      {gamePhase === 'thinking' && thinkingPhase && (
        <div className="thinking-overlay">
          <div className="thinking-content">
            ...
            <div className="thinking-text">Calculating slide trajectory...</div>
            <div className="thinking-subtext">🛝 Finding the perfect slide... 🛝</div>
          </div>
        </div>
      )}
      ...
      {gamePhase === 'mourning' && (
        <div className="mourning-overlay">
          <div className="mourning-content">
            ...
            <div className="mourning-text">Slide went too far!</div>
            <div className="mourning-subtext">🛝 Couldn't hit the target... 🛝</div>
          </div>
        </div>
      )}
